...
export async function GET(req: NextRequest) {
  console.log('API route /api/select_items/products called');
  ...
  const backendUrl = new URL(`${API_URL}/products/select-items`);
  
  console.log('Fetching product select items from API URL:', backendUrl.toString());
