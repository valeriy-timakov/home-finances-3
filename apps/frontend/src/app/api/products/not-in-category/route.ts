...
export async function GET(req: NextRequest) {
  console.log('API route /api/products/not-in-category called');
  ...
  const backendUrl = new URL(`${API_URL}/products/not-in-category`);
  if (categoryId) {
    backendUrl.searchParams.append('categoryId', categoryId);
  }
  
  console.log('Fetching products not in category from API URL:', backendUrl.toString());
